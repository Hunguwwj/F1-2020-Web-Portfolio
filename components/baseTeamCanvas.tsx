...
export type ViewKey = "side" | "front" | "cockpit";
export type TextEffect = "blink-slide" | "decode-slide" | "float" | "blur";
export type TitleLayer = "behind-car" | "front-car";
...
export default function BaseTeamCanvas({
  theme,
  model,
  viewData,
  viewOrder = ["side", "front", "cockpit"],
  initialView = "side",
}: BaseCanvasProps) {
        ...
        >
          <div
            ...
            style={{
              ...
              backgroundColor: theme.cinematicBar,
            }}
          />
          <div
            ref={bottomBarRef}
        ...
        {currentView.labelLeft && (
          <div className={currentView.leftLabelClass}>
            <div
              ...
              style={{ color: getLabelColor(currentView, theme) }}
            >
              {currentView.labelLeft}
            </div>
          </div>
              ...
              <button
                ...
                style={{
                  ...
                  color: isActive
                    ...
                    : theme.buttonIdleText,
                  borderColor: isActive
                    ? theme.buttonActiveBorder
                    : theme.buttonIdleBorder,
                }}
              >
                {label}
              </button>
